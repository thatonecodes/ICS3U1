...
public class GetRequest extends HttpRequest {
	 ...
	 * This method parses the URL and returns true if a non-empty query component is
	 * present.
	 *
	...
	/**
	 * Sends a HTTP GET request to "https://http.cat/{YOUR_HTTP_CODE}" for nice cat
	 * images.
	 * 
	 * @param httpCode The HTTP code to get the image for (e.g., "200", "400", etc.)
	 * @return String The String received from the HttpResponse to
	 *         "https://http.cat/{YOUR_HTTP_CODE}", link to an image.
	 */
